...
import locationTypesRoutes from './routes/locationTypes.js';
...
import unitConversionsRoutes from './routes/unitConversions.js';
...
app.use('/api', locationTypesRoutes);
...
app.use('/api', unitConversionsRoutes);
